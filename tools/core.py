...
def generate_private_key(filename: str, password: str):
    ...
    # Création du fichier "filename" contenant le clés privées (p,q,n) chiffrées avec le "password"
...
def generate_csr(private_key, filename: str, config: Configuration):
    ...
    # Ecriture de la requëte de signature du certificat dans le fichier PEM
